\begin{titlepage}
    ...
    \vspace*{-0.4cm}
    \textsc{\large Department of Computer, Control and \\ Management Engineering Antonio Ruberti}\\[2.0 cm]	% Department Name
    \vspace*{1cm}
    ...
    \textsc{Master in Artificial Intelligence and Robotics}\\[0.5 cm] % Course Name
